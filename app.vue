...
const overallRecommendation = computed(() => {
  ...
  if (mouthCentering < 75 && chin >= 75) return { title: "พบตำแหน่งปากที่ไม่สมดุล", message: "AI ตรวจพบว่าตำแหน่งปากของคุณไม่สมดุลกับใบหน้าแม้ว่าโครงสร้างคางจะดี ปัญหานี้มักเกี่ยวข้องกับการเรียงตัวของฟัน การจัดฟันใสสามารถช่วยแก้ไขเรื่องนี้ได้โดยตรง", cta: "สนใจปรึกษาเรื่องการจัดฟันใส" };
