...
// --- 1. ตัวแปรใหม่สำหรับจัดการ Modal ---
const isModalVisible = ref(false);
const modalTitle = ref('');
const modalContent = ref('');


// --- 2. เนื้อหาสำหรับข้อตกลงและนโยบาย ---
...
// ตัวแปรและฟังก์ชันอื่นๆ ทั้งหมดเหมือนเดิม
...
const analysisScores = ref({ symmetry: null, cant: null, chin: null });
